...
class IntelligenceSource(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    name: Mapped[str] = mapped_column(String(180), nullable=False)
    kind: Mapped[IntelligenceSourceKind] = mapped_column(SqlEnum(IntelligenceSourceKind), nullable=False, index=True)
...
class IntelligenceJob(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    source_id: Mapped[int] = mapped_column(ForeignKey("intelligence_sources.id"), nullable=False, index=True)
...
class Lead(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    job_id: Mapped[int] = mapped_column(ForeignKey("intelligence_jobs.id"), nullable=False, index=True)
    ...
    contact_points: Mapped[list["LeadContactPoint"]] = relationship(
...
class KVKKDisclosureVersion(Base):
    __tablename__ = "kvkk_disclosure_versions"
